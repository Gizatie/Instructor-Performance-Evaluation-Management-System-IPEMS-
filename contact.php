...
<?php echo @$err; ?>
        ...
        <div class="col-md-4" style="margin-top:30px">
            ...
            <p>
                E-20 Sector 63<br>Debre Tabor, Ethiopia 6300<br>
            </p>
            <p><i class="fa fa-phone"></i>
                <abbr title="Phone">P</abbr>: (251) 9000000</p>
            <p><i class="fa fa-envelope-o"></i>
                <abbr title="Email">E</abbr>: <a href="mailto:name@example.com">name@gmail.com</a>
            </p>
